...
The ladder of §FS-006-project-interface.10 is realized as a **capability
...
rendering the first missing rung's sentence. This gives §REQ-001-boundary.1's
...
a lie (§FS-001-forge-interface.6 has the same stance toward sources).
