...
Remote sources fetch per the [§FS-001-forge-interface](../../requirements.md#fs-001-forge-interface-ephor-reaches-every-forge-and-issue-tracker-through-one-provider-interface) capability set —
...
attached, and fails per [§FS-001-forge-interface.6](../../requirements.md#6-a-source-that-did-not-answer-says-so-and-says-which-kind-of-not): explicitly, visibly,
...
same-key reports into one matter under [§FS-003-feed-categories.5](../../requirements.md#5-one-subject-is-one-row-however-many-sources-reported-it), links
referenced matters ([§FS-007-matters.2](../../requirements.md#2-same-subject-one-matter-related-subjects-linked-matters)), recomputes fingerprints, and
...
([§FS-008-attribution.4](../../requirements.md#4-unattributed-is-a-place-not-a-fate)).
...
([§FS-006-project-interface.9](../../requirements.md#9-offers-the-projects-actions)). A chosen offer, verb, or dispatch is a
...
matter's fingerprint at that moment ([§FS-005-dispatch.4](../../requirements.md#4-the-ledger-is-ephors-record-and-never-the-truth-about-the-work)).
...
component named ([§FS-005-dispatch.5](../../requirements.md#5-an-item-that-moved-reopens-its-work), [§FS-007-matters.5](../../requirements.md#5-an-event-moves-state-and-resurfacing-names-its-reason)); a done matter
that moved returns unread with the same reason. Nothing resurfaces as a
side effect of merely looking ([§FS-005-dispatch.5](../../requirements.md#5-an-item-that-moved-reopens-its-work)).
...
([§FS-001-forge-interface.6](../../requirements.md#6-a-source-that-did-not-answer-says-so-and-says-which-kind-of-not)) — because a watch that cannot be believed
